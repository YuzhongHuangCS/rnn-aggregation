...
W2 = tf.get_variable('W2', shape=(n_hidden1, n_hidden2), initializer=tf.glorot_uniform_initializer())
b2 = tf.get_variable('b2', shape=(1, n_hidden2), initializer=tf.zeros_initializer())
W3 = tf.get_variable('W3', shape=(n_hidden2, 5), initializer=tf.glorot_uniform_initializer())
