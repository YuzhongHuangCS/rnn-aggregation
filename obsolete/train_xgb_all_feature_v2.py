...
with open('dataset_all_2.pickle', 'rb') as f:
...
drop_list = [
		...
		#'h2_1', 'h2_2', 'h2_3', 'h2_4', 'h2_5', 'h3_1', 'h3_2', 'h3_3', 'h3_4', 'h3_5', 'h4_1', 'h4_2', 'h4_3', 'h4_4', 'h4_5',
	   #'n_forecasts', 'n_forecasts_b', 'n_forecasts_c', 'n_forecasts_d',
...
for train_index, test_index in kf.split(ifp_all):
	...
	for i, v in enumerate(test_Y_prob):
		...
		test_Y_brier.append([human_brier, arima_brier, m4_brier, arw_brier, dsholt_brier, dsholtd_brier, dsrw_brier, dsses_brier, ets_brier, grw_brier, m4c_brier, mean_brier, nnetar_brier, rw_brier, rwd_brier, rws_brier, sltmar_brier, tbats_brier, theta_brier, predict_brier])
	...
	for ifp in set(test_df['ifp_id']):
		...
		two_ideal = np.mean(np.min([test_Y_brier[index][:, 0], test_Y_brier[index][:, 1]], axis=0))
	...
	print(briers_mean[0], briers_mean[1], briers_mean[-3], briers_mean[-2], briers_mean[-1])
	splits.append([briers_mean[0],  briers_mean[1], briers_mean[-3], briers_mean[-1]])
	counter += 1
