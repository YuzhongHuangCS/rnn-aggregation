...
with tf.Session() as sess:
	...
	valid_loss, valid_pred, att_scores_valid1, att_scores_valid2 = sess.run(
		[loss_weighted, prob, att_scores, att_scores2],
			feed_dict={
	...
	with open('att_cache2_{}.pickle'.format(fold_index), 'wb') as fout:
		pickle.dump([att_scores_valid1, att_scores_valid2, gather_index_valid, ifp_valid, db_answer, db], fout, pickle.HIGHEST_PROTOCOL)
