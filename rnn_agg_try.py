...
'''
.drop(columns=['x_acf1', 'x_acf10', 'diff1_acf1', 'diff1_acf10',
...
state_series, _ = tf.nn.dynamic_rnn(cell, combined_input, sequence_length=seq_length_placeholder, initial_state=zero_state, parallel_iterations=64)
