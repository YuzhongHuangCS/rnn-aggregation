...
with tf.Session() as sess:
	...
	valid_loss, valid_pred, att_scores_valid = sess.run(
		[loss_weighted, prob, att_scores],
			feed_dict={
	...
	with open('rnn_cache_{}.pickle'.format(fold_index), 'wb') as fout:
		pickle.dump([att_scores_valid, gather_index_valid, ifp_valid, db_answer, db], fout, pickle.HIGHEST_PROTOCOL)
